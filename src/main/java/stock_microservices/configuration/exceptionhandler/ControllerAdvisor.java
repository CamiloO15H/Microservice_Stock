package stock_microservices.configuration.exceptionhandler;

import stock_microservices.adapters.driven.jpa.mysql.exception.CategoriesAlreadyExistsException;
...
import stock_microservices.configuration.constans.Constants;
import stock_microservices.domain.exception.EmptyFieldException;
import stock_microservices.domain.exception.NegativeNotAllowedException;
